...
## Key Features
- Developed in Rust, ensuring excellent performance and low resource consumption.
- Implements best practices for security and privacy, such as storing sensitive information like passwords in the system keychain.
- The macOS version is notarized by Apple, allowing direct installation without complicated authorization.

> Disclaimer: While we have implemented multiple security measures, the security and vulnerability fixes of the underlying kernel depend on the sing-box project, and the associated risks and fixes are not directly controlled by this project.
...
> See [Support Level Explanation](#support-level-explanation) for details on each tier.
