...
- 采用安全的 Rust 语言开发，性能优异且资源占用低。
- 使用安全与隐私保护最佳实践，如密码等机密信息存储在系统钥匙串中。
- macOS 版本已通过苹果官方公证，可直接下载安装，无需繁琐授权。


> 免责声明：我们已采取多项安全措施，但底层内核的安全性及漏洞修复依赖于 sing-box 项目，相关风险和修复并非本项目可直接控制。
